...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            float aspectRatio1 = rectangle1.calculateAspectRatio();
            Console.WriteLine(aspectRatio1);
            if (aspectRatio1 > 1)
            {
                Console.WriteLine("obdélník je širší než vyšší");
            }
            else if (aspectRatio1 < 1)
            {
                Console.WriteLine("obdélník je vyšší než širší");
            }
            else
            {
            ...
            bool containtsPoint1 = rectangle1.containsPoint(8, 8);
            if (containtsPoint1 == true)
            {
                Console.WriteLine("bod je v rectangle");
            }
            else
            {
                Console.WriteLine("bod není v rectangle");
            }
